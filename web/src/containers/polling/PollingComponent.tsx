...
export function PollingComponent<T>(
  props: PollingComponentProps<T> & HTMLProps<void>,
) {
  const [data, setData] = useState(undefined);
  const [polling, setPolling] = useState(false);

  async function onStatus<T>(
    pollingStatus: PollingStatus<T>,
    fetchStatus: FetchStatusCallback<T>,
  ) {
  ...
  let loadingMsg = polling
    ? "Processing of upgrades for this address is queued"
    : undefined;
  return (
    <>
